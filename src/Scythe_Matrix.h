...
namespace SCYTHE {
  ...
  template <class T>
	...
	Matrix<T> &operator= (const Matrix<S> &);
      ...
      /* Element-by-element multiplication/assignment */  // added by AK
      Matrix<T> &operator&= (const Matrix<T> &);
  ...
  template <class T>
    bool operator== (const Matrix<T> &, const Matrix<T> &);                    // comparison of two matrices

  template<class T>
    bool operator== (const Matrix<T> &, const typename Matrix<T>::ttype &);    // compare matrix and scalar

  template <class T>
    bool operator== (const typename Matrix<T>::ttype &, const Matrix<T> &);    // compare scalar and matrix
  ...
  /* Element-by-element multiplication */  // added by AK
  template <class T>
    Matrix<T> operator& (Matrix<T>, const Matrix<T> &);
