...
namespace SCYTHE {
	 ...
	 */
	template <class T>
        Matrix<T> chol_solve (const Matrix<T> &, const Matrix<T> &, const Matrix<T> &);
	...
	template <class T>
	void lu_decomp (Matrix<T>, Matrix<T> &, Matrix<T> &, Matrix<int> &);
	 ...
	 */
	template <class T>
	Matrix<T> lu_solve (Matrix<T>, const Matrix<T> &, const Matrix<T> &, const Matrix<T> &, const Matrix<int> &);
